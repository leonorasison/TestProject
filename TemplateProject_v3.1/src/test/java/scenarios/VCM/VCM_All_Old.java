...
public class VCM_All_Old extends TestBase{
	...
	public void VCM_Step_1 () throws Exception {
		...
		VIPVCMPage.contents.UpgradeInProgressClose.click();
		...
		Thread.sleep(2000);
		VIPVCMPage.contents.SideMenuVCM.verifyDisplayed(true, 5);
		...
		//VIPVCMPage.contents.UpgradeInProgressClose.click();
		Thread.sleep(2000);
		VIPLandingPage.contents.CompanyNameTextbox.sendKeys("Unilever PLC");
	...
	public void VCM_Step_2 () throws Exception {
		...
		VIPVCMPage.contents.ReferenceDataValue1_1.verifyText(Rev + " USD bn");
		...
		VIPVCMPage.contents.ReferenceDataValue1_1.verifyText(COGS + " USD bn");
		...
		VIPVCMPage.contents.ReferenceDataValue1_1.verifyText(SGA + " USD bn");
		...
		VIPVCMPage.contents.ReferenceDataName2_2.verifyText("EBIT margin chg. forecast (" + Period2 + "- " + Period3 + ")");
		if (EBITME3 >= 0) {
...
//		VIPVCMPage.contents.VCOCategorySGA.click();
		...
		VIPVCMPage.contents.VCMSaveModalMessage.verifyText("Your Value Case Model is now successfully saved. You can view the same in the “My Last Reports” section on the main page.");
		...
		VIPVCMPage.contents.VCMSaveModal.verifyDisplayed(false);
		VIPVCMPage.contents.VCMBodyTitle.verifyText("VCO Summary");
