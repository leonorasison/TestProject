...
public class CIA_All extends TestBase{
	...
	public void CIA_All () throws Exception {
		...
		String x = change.substring(0, change.length() - 3);
		String y = change.substring(change.length() - 2, change.length() - 1);		
        ...
        String a = words[5];
        String b = words[17];
        String a1 = a.substring(0, change.length() - 3);
        String a2 = a.substring(change.length() - 2, change.length() - 1);
        String b1 = b.substring(0, change.length() - 3);
        String b2 = b.substring(change.length() - 2, change.length() - 1);
        //VIPCIAPage.contents.TRSKeyInsightsText.verifyText("Pfizer Inc.'s TRS declined by " + a1 + "." + a2 + " since Dec’19 which is worse than the peer median decline of " + b1 + "." + b2);
        VIPCIAPage.contents.TRSKeyInsightsText.verifyText("Pfizer Inc.'s TRS declined by 5.1% since Dec’19 which is worse than the peer median decline of 4.3%");
		...
		VIPCIAPage.contents.EBITTimeframe.verifyText("2021E");
		...
		VIPCIAPage.contents.EPSTimeframe.verifyText("2021E");
		VIPCIAPage.contents.TimeframeDropdown.verifyDisplayed(true, 2);
		VIPCIAPage.contents.ForecastSource.verifyDisplayed(true, 5);
		VIPCIAPage.contents.ForecastSource.verifyText("Source: Based on consensus analyst estimates from S&P Capital IQ; Accenture Client Value Services.");
		...
		VIPCIAPage.contents.FCFTimeframe.verifyText("2021E");
		VIPCIAPage.contents.TimeframeDropdown.verifyDisplayed(true, 2);
		VIPCIAPage.contents.ForecastSource.verifyDisplayed(true, 5);
		VIPCIAPage.contents.ForecastSource.verifyText("Source: Based on consensus analyst estimates from S&P Capital IQ; Accenture Client Value Services.");
		...
		VIPCIAPage.contents.CapexTimeframe.verifyText("2021E");
		VIPCIAPage.contents.TimeframeDropdown.verifyDisplayed(true, 2);
		VIPCIAPage.contents.ForecastSource.verifyDisplayed(true, 5);
		VIPCIAPage.contents.ForecastSource.verifyText("Source: Based on consensus analyst estimates from S&P Capital IQ; Accenture Client Value Services.");
		...
		VIPCIAPage.contents.RevenueTimeframe.verifyText("2021E");
		VIPCIAPage.contents.TimeframeDropdown.verifyDisplayed(true, 2);
		VIPCIAPage.contents.ForecastSource.verifyDisplayed(true, 5);
		VIPCIAPage.contents.ForecastSource.verifyText("Source: Based on consensus analyst estimates from S&P Capital IQ; Accenture Client Value Services.");
		...
		//VIPCIAPage.contents.UpgradeInProgressClose.click();
		VIPLandingPage.contents.CompanyNameTextbox.verifyDisplayed(true, 10);
		VIPLandingPage.contents.CompanyNameTextbox.sendKeys("Herti");
		Thread.sleep(3000);
		VIPLandingPage.contents.CompanyTypeAhead.waitForExist(true, 20);
		Thread.sleep(3000);
		VIPLandingPage.contents.CompanyTypeAhead.verifyDisplayed(true, 20);
		...
		VIPCompetitorPage.contents.CompetitorSearchbox.sendKeys("Herti");
		Thread.sleep(3000);
		VIPLandingPage.contents.CompanyTypeAhead.waitForExist(true, 20);
		Thread.sleep(3000);
		VIPLandingPage.contents.CompanyTypeAhead.verifyDisplayed(true, 20);
		...
		//VIPCIAPage.contents.UpgradeInProgressClose.click();
		VIPLandingPage.contents.CompanyNameTextbox.verifyDisplayed(true, 10);
		VIPLandingPage.contents.CompanyNameTextbox.sendKeys("OTCPK:CSTI");//Costar Tech
		Thread.sleep(3000);
		VIPLandingPage.contents.CompanyTypeAhead.waitForExist(true, 20);
		Thread.sleep(3000);
		VIPLandingPage.contents.CompanyTypeAhead.verifyDisplayed(true, 20);
		...
		VIPCIAPage.contents.FootNote.verifyText("Note: Companies with TRS not available (AVIC International Holdings Limited,Hitachi High-Tech Corporation,Ingenico Group - GCS) are removed from the analysis.");
		VIPCIAPage.contents.KeyInsight.verifyDisplayed(true, 2);
		...
		VIPCompetitorPage.contents.CompetitorSearchbox.sendKeys("OTCPK:CSTI");//Costar Technologies, Inc.
        Thread.sleep(3000);
